...
public class BlockRailModelConstructor extends BlockContainer{
    ...
    {
		//OPEN GUI
		player.openGui(ERC_Core.INSTANCE, ERC_Core.GUIID_RailModelConstructor, player.worldObj, x, y, z);
        return true;
    }
