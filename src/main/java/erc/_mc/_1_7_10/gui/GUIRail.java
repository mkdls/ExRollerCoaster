...
import erc._mc._1_7_10.network.ERC_MessageRailGUICtS;
...
//        int length = 27;
		...
		AutoRailConnectionManager.clickedTileForGUI.getRail().SpecialGUIInit(this);
    }
    ...
    {
		super.onGuiClosed();
		AutoRailConnectionManager.CloseRailGUI();
	}
...
//        
        ...
        //drawString(this.fontRendererObj, ""+AutoRailConnectionManager.clickedTileForGUI.GetPosNum(), 43, 29, 0xffffff);
        //drawString(this.fontRendererObj, String.format("% 2.1f",AutoRailConnectionManager.clickedTileForGUI.BaseRail.Power), 37, 56, 0xffffff);
        //drawString(this.fontRendererObj, AutoRailConnectionManager.clickedTileForGUI.SpecialGUIDrawString(), 42, 172, 0xffffff);
    }
	...
	protected void actionPerformed(GuiButton button) {
		IRail rail = AutoRailConnectionManager.clickedTileForGUI.getRail();
