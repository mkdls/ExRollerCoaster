...
public class entitySUSHI extends Entity {
	...
	{
		tex = new ResourceLocation(ERC_Core.MODID,"textures/entities/SUSHI.jpg");
		try {
			model1 = AdvancedModelLoader.loadModel(new ResourceLocation(ERC_Core.MODID, "models/SUSHI/" + "SUSHI_m.obj"));
			model2 = AdvancedModelLoader.loadModel(new ResourceLocation(ERC_Core.MODID, "models/SUSHI/" + "SUSHI_t.obj"));
			model3 = AdvancedModelLoader.loadModel(new ResourceLocation(ERC_Core.MODID, "models/SUSHI/" + "SUSHI_w.obj"));
			model4 = AdvancedModelLoader.loadModel(new ResourceLocation(ERC_Core.MODID, "models/SUSHI/" + "SUSHI_e.obj"));
			model5 = AdvancedModelLoader.loadModel(new ResourceLocation(ERC_Core.MODID, "models/SUSHI/" + "SUSHI_g.obj"));
		}
		catch(Exception e){
...
//		dataWatcher.addObject(21, new Integer(1));
		dataWatcher.addObject(19, new Integer((int) java.lang.Math.floor(r.nextInt(44)/10d)));
	}
